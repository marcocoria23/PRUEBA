 ...
 */
public class V3QEjecucionFederal {
...
"        from TR_FED_EJECUCION where  ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"        from TR_FED_EJECUCION where  ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO AND EXPE_AÑO NOT IN ('2021','2022','2023','2020','2024','2025')) WHERE SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM TR_FED_EJECUCION   \n" +
"WHERE \n" +
...
"and  ((substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"' ) or  (clave_organo='"+PValidacion.clave_organo+"' ))";
 ...
 public ArrayList FECHA_PRESENTACION_FUT(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_PRESENTACION,'DD/MM/YYYY')FECHA_PRESENTACION,\n" +
"TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM TR_FED_EJECUCION   \n" +
"WHERE \n" +
...
public ArrayList FECHA_CONCLUSION_FUT(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_CONCLUSION,'DD/MM/YYYY')FECHA_CONCLUSION,\n" +
"TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM TR_FED_EJECUCION   \n" +
"WHERE \n" +
...
"and  ((substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"' ) or  (clave_organo='"+PValidacion.clave_organo+"' ))";
   ...
   public ArrayList Duplicidad_expediente(){
      conexion.Conectar();
      Array = new ArrayList();
       sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2 FROM TR_FED_EJECUCION\n" +
...
"select CLAVE_ORGANO,expediente_clave,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2 from TR_FED_EJECUCION \n" +
...
"ORDER BY CLAVE_ORGANO,expediente_clave2";
    ...
    public ArrayList Fecha_PresentacionNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select * from (select ESTATUS_EXPE,CLAVE_ORGANO,EXPEDIENTE_CLAVE,to_char(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_PRESENTACION,'dd/mm/yyyy')FECHA_PRESENTACION\n" +
"from TR_FED_EJECUCION  \n" +
"WHERE to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy') < to_date(FECHA_PRESENTACION,'dd/mm/yyyy')) where  \n" +
          " FECHA_PRESENTACION <> '09/09/1899'  and clave_organo='"+PValidacion.clave_organo+"' or substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"' \n" +
          "and FECHA_PRESENTACION <> '09/09/1899'    \n";
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Fecha_ConclusionNE(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select * from (select ESTATUS_EXPE,clave_organo,expediente_clave,to_char(fecha_apertura_expediente,'DD/MM/YYYY') fecha_apertura_expediente,to_char(fecha_conclusion,'DD/MM/YYYY') fecha_conclusion  \n" +
          "from TR_FED_EJECUCION   where \n" +
          " fecha_conclusion <> '09/09/1899'  and clave_organo='"+PValidacion.clave_organo+"' or substr(clave_organo,0,2)='"+PValidacion.clave_entidad+"' \n" +
          "and fecha_conclusion <> '09/09/1899'\n" +
          " ) where  to_date(fecha_conclusion,'dd/mm/yyyy')  < to_date(fecha_apertura_expediente,'dd/mm/yyyy')";
      //System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {

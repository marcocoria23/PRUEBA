 ...
 */
public class V3QPart_act_ordinarioFederal {
...
") where expediente_clave not in (select expediente_clave from TR_FED_part_act_ordinario where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"FROM TR_FED_part_act_ordinario\n" +

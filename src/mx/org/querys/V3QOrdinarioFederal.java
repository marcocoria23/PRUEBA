 ...
 */
public class V3QOrdinarioFederal {
    ...
    public ArrayList Año_JudicialCampeche() {
        ...
        sql = "SELECT * FROM (\n"
                ...
                + "        from TR_FED_ordinario ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='" + PValidacion.clave_entidad + "'  \n"
    ...
    public ArrayList Año_Expe_OrdinarioNE() {
        ...
        sql = "SELECT * FROM(\n"
                ...
                + "from TR_FED_ordinario ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO AND EXPE_AÑO NOT IN ('2021','2022','2023','2020','2024','2025')) WHERE SUBSTR(CLAVE_ORGANO,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "or clave_organo='" + PValidacion.clave_organo + "'";
        //System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
    ...
    public ArrayList FECHA_APERTURA_EXPEDIENTE_FUT() {
        ...
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_ORDINARIO  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_DICTO_RESOLUCIONFE_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_DICTO_RESOLUCIONFE,'DD/MM/YYYY')FECHA_DICTO_RESOLUCIONFE,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_ORDINARIO  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_DICTO_RESOLUCIONAP_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_DICTO_RESOLUCIONAP,'DD/MM/YYYY')FECHA_DICTO_RESOLUCIONAP,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_ORDINARIO  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_RESOLUCIONAJ_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_RESOLUCIONAJ,'DD/MM/YYYY')FECHA_RESOLUCIONAJ,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_ORDINARIO  \n"
                + "WHERE \n"
    ...
    public ArrayList Duplicidad_expediente() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2 from TR_FED_ORDINARIO\n"
                ...
                + "select CLAVE_ORGANO,expediente_clave,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2 from TR_FED_ORDINARIO \n"
    ...
    public ArrayList Fecha_PresentacionNE() {
        ...
        sql = "select * from (select entidad_clave,CLAVE_ORGANO,EXPEDIENTE_CLAVE,to_char(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')FECHA_APERTURA_EXPEDIENTE,to_char(fecha_pres_demanda,'dd/mm/yyyy')fecha_pres_demanda\n"
                ...
                + "WHERE to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy') < to_date(FECHA_PRES_DEMANDA,'dd/mm/yyyy')) where fecha_pres_demanda <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and fecha_pres_demanda <> '09/09/1899'\n";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
    ...
    public ArrayList Fecha_PresentacionAdmiNE() {
        ...
        sql = "select * from (select entidad_clave,CLAVE_ORGANO,EXPEDIENTE_CLAVE,to_char(FECHA_ADMI_DEMANDA,'dd/mm/yyyy')FECHA_ADMI_DEMANDA,to_char(fecha_pres_demanda,'dd/mm/yyyy')fecha_pres_demanda \n"
                + "from TR_FED_ORDINARIO \n"
                + "WHERE to_date(FECHA_ADMI_DEMANDA) < to_date(FECHA_PRES_DEMANDA)) where fecha_pres_demanda <> '09/09/1899' and FECHA_ADMI_DEMANDA <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and fecha_pres_demanda <> '09/09/1899' and FECHA_ADMI_DEMANDA <> '09/09/1899'";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
    ...
    public ArrayList Fecha_Admi_demandaNE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(fecha_admi_demanda,'DD/MM/YYYY')fecha_admi_demanda\n"
                + "from TR_FED_ordinario where \n"
    ...
    public ArrayList Fecha_Audiencia_PrelimNE() {
        ...
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(fecha_audiencia_prelim,'DD/MM/YYYY') fecha_audiencia_prelim  \n"
                + "from TR_FED_ordinario where fecha_audiencia_prelim <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and fecha_audiencia_prelim <> '09/09/1899'\n"
    ...
    public ArrayList Fecha_Dicto_ResolucionFE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_DICTO_RESOLUCIONFE,'DD/MM/YYYY') FECHA_DICTO_RESOLUCIONFE  \n"
                + "from TR_FED_ordinario where \n"
                + " FECHA_DICTO_RESOLUCIONFE <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_DICTO_RESOLUCIONFE <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_DICTO_RESOLUCIONFE,'dd/mm/yyyy')  < to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        //System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
    ...
    public ArrayList Fecha_Dicto_ResolucionAP() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_DICTO_RESOLUCIONAP,'DD/MM/YYYY') FECHA_DICTO_RESOLUCIONAP  \n"
                + "from TR_FED_ordinario where \n"
                + " FECHA_DICTO_RESOLUCIONAP <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_DICTO_RESOLUCIONAP <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_DICTO_RESOLUCIONAP,'dd/mm/yyyy')  < to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        //System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
    ...
    public ArrayList Fecha_ResolucionAJ() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_RESOLUCIONAJ,'DD/MM/YYYY') FECHA_RESOLUCIONAJ  \n"
                + "from TR_FED_ordinario where \n"
                + " FECHA_RESOLUCIONAJ <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_RESOLUCIONAJ <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_RESOLUCIONAJ,'dd/mm/yyyy')  < to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        //System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
   ...
   //ORDINARIO LA FECHA DE AUDIENCIA CELEBRARA NO DEBE SER MENOR A LA FECHA DE APERTURA DEL EXPEDIENTE
    ...
    public ArrayList Fecha_Aud_Presentacion() {
        ...
        sql = "select * from (SELECT S.ENTIDAD_CLAVE,P.CLAVE_ORGANO,P.EXPEDIENTE_CLAVE,to_char(P.FECHA_AUDIEN_CELEBRADA,'DD/MM/YYYY')FECHA_AUDIEN_CELEBRADA,to_char(S.FECHA_PRES_DEMANDA,'DD/MM/YYYY') FECHA_PRES_DEMANDA, P.TIPO_PROCED, P.ID_AUDIENCIA\n"
                + "FROM TR_FED_AUDIENCIAS P,TR_FED_ORDINARIO S\n"

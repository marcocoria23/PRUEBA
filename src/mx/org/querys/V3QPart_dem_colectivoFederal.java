 ...
 */
public class V3QPart_dem_colectivoFederal {
...
" CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from TR_FED_part_DEM_colectivo where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +
...
"FROM TR_FED_part_DEM_colectivo\n" +

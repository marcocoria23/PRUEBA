...
"WHERE ((TIPO_ASUNTO ='9' or TIPO_ASUNTO is null) AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"' \n" +
...
"WHERE ((ESTATUS_DEMANDA ='9' OR ESTATUS_DEMANDA IS NULL)AND (CLAVE_ORGANO||EXPEDIENTE_CLAVE NOT IN ('12035106/2022')) AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"' \n" +
" or clave_organo='"+PValidacion.clave_organo+"' and periodo = '"+PValidacion.periodo+"'))"; 
      //System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
"WHERE ((ESTATUS_EXPEDIENTE ='9' OR ESTATUS_EXPEDIENTE IS NULL ) AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"' \n" +
" or clave_organo='"+PValidacion.clave_organo+"' and periodo = '"+PValidacion.periodo+"'))"; 
      //System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
"OTRO_ESP_SOLUCION_AJ IS NOT NULL OR FECHA_DICTO_RESOLUCION_AJ IS NOT NULL OR TIPO_SENTENCIA_AJ IS NOT NULL OR MONTO_SOLUCION_AJ IS NOT NULL ) where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"' \n" +
...
"FECHA_DICTO_RESOLUCION_AP IS NOT NULL OR MONTO_SOLUCION_AP IS NOT NULL OR FORMA_SOLUCION_AJ IS NOT NULL OR \n" +
"OTRO_ESP_SOLUCION_AJ IS NOT NULL OR FECHA_DICTO_RESOLUCION_AJ IS NOT NULL OR TIPO_SENTENCIA_AJ IS NOT NULL OR MONTO_SOLUCION_AJ IS NOT NULL ) where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"' \n" +
" or clave_organo='"+PValidacion.clave_organo+"' and periodo = '"+PValidacion.periodo+"') WHERE INCOMPETENCIA='9' OR INCOMPETENCIA IS NULL";      
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
              Array.add(new String[]{
...
"MONTO_SOLUCION_TA IS NOT NULL OR\n" +
...
"MONTO_SOLUCION_AJ IS NOT NULL\n" +
") where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"' \n" +
" or clave_organo='"+PValidacion.clave_organo+"' and periodo = '"+PValidacion.periodo+"') WHERE ESTATUS_DEMANDA IN ('9') OR  ESTATUS_DEMANDA IS NULL";     
      //System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
...
"MONTO_SOLUCION_AJ IS NOT NULL\n" +
") where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' and periodo = '"+PValidacion.periodo+"' \n" +
" or clave_organo='"+PValidacion.clave_organo+"' and periodo = '"+PValidacion.periodo+"') WHERE ESTATUS_EXPEDIENTE='9' OR ESTATUS_EXPEDIENTE IS NULL";      
//System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
...
"OTRO_ESP_SOLUCION_AJ IS NOT NULL OR FECHA_DICTO_RESOLUCION_AJ IS NOT NULL OR TIPO_SENTENCIA_AJ IS NOT NULL OR MONTO_SOLUCION_AJ IS NOT NULL) and \n"

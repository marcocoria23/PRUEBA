 ...
 */
public class V3OrdinarioFederal {
...
public ArrayList Tipo_asuntoNI(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select CLAVE_ORGANO,EXPEDIENTE_CLAVE,decode(TIPO_ASUNTO,'9','No_identificado')TIPO_ASUNTO from TR_FED_ORDINARIO\n" +
...
" or clave_organo='"+PValidacion.clave_organo+"' )) "; 
      ...
      conexion.close();
            ...
            Logger.getLogger(V3OrdinarioFederal.class.getName()).log(Level.SEVERE, null, ex);
        }
    return Array;
 }
...
public ArrayList Tipo_asunto_ColectNI(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(TIPO_ASUNTO,'2','Colectivo') TIPO_ASUNTO FROM TR_FED_ORDINARIO \n" +
"WHERE (TIPO_ASUNTO=2 AND ( CONTRATO_ESCRITO IS NOT NULL OR  TIPO_CONTRATO IS NOT NULL ) AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Contrato_escritoNI(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(CONTRATO_ESCRITO,'2','No','9','No identificado') CONTRATO_ESCRITO FROM TR_FED_ORDINARIO \n" +
"WHERE (TIPO_ASUNTO=1 AND CONTRATO_ESCRITO IN (2,9) and ( TIPO_CONTRATO IS NOT NULL ) AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Ta_Colectivo(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(TIPO_ASUNTO,'2','Colectivo') CONTRATO_ESCRITO  FROM TR_FED_ORDINARIO \n" +
...
"OTRO_ESP_RECLAMADO IS NOT NULL OR  AGUINALDO IS NOT NULL OR  VACACIONES IS NOT NULL OR  PRIMA_VACACIONAL IS NOT NULL OR  PRIMA_ANTIGUEDAD IS NOT NULL OR  OTRO_TIPO_PREST IS NOT NULL OR  OTRO_ESP_PRESTAC IS NOT NULL)AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Mot_conflicto(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(CIRCUNS_MOTIVO_CONFL,'2','No','9','No identificado') CIRCUNS_MOTIVO_CONFL FROM TR_FED_ORDINARIO \n" +
...
"HOSTIGAMIENTO IS NOT NULL OR  ACOSO_SEXUAL IS NOT NULL)AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Pago_prestaciones(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(PAGO_PRESTACIONES,'2','No','9','No identificado') PAGO_PRESTACIONES FROM TR_FED_ORDINARIO \n" +
"WHERE (PAGO_PRESTACIONES in (2,9) and TIPO_ASUNTO=1 and ( AGUINALDO IS NOT NULL OR  VACACIONES IS NOT NULL OR  PRIMA_VACACIONAL IS NOT NULL OR  PRIMA_ANTIGUEDAD IS NOT NULL OR  OTRO_TIPO_PREST IS NOT NULL OR  OTRO_ESP_PRESTAC IS NOT NULL)AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Cons_expedida(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(CONSTANCIA_CONS_EXPEDIDA,'2','No','9','No identificado') CONSTANCIA_CONS_EXPEDIDA FROM TR_FED_ORDINARIO\n" +
"WHERE (CONSTANCIA_CONS_EXPEDIDA in (2,9) AND incompetencia=2 and  (CONSTANCIA_CLAVE IS NOT NULL)AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Preve_demanda(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(PREVE_DEMANDA,'2','No','9','No identificado') PREVE_DEMANDA FROM TR_FED_ORDINARIO\n" +
"WHERE (PREVE_DEMANDA in (2,9) AND incompetencia=2 and  (DESAHOGO_PREV_DEMANDA IS NOT NULL)AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Estatus_demaNi(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(ESTATUS_DEMANDA,'9','No_identificado') ESTATUS_DEMANDA,REPLACE(COMENTARIOS,',','')COMENTARIOS from TR_FED_ORDINARIO\n" +
"WHERE (ESTATUS_DEMANDA =9 AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Impiden_admision_demanda(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(ESTATUS_DEMANDA,'1','Admitida','9','No identificado') ESTATUS_DEMANDA FROM TR_FED_ORDINARIO\n" +
"WHERE (ESTATUS_DEMANDA IN (1,9) AND INCOMPETENCIA=2 AND (CAU_IMP_ADM_DEMANDA IS NOT NULL) AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList audiencia_preliminar(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(AUDIENCIA_PRELIM,'2','No','9','No identificado') AUDIENCIA_PRELIM FROM TR_FED_ORDINARIO\n" +
"WHERE (AUDIENCIA_PRELIM in (2,9) AND incompetencia=2 and  (FECHA_AUDIENCIA_PRELIM IS NOT NULL)AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList audiencia_juicio(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(AUDIENCIA_JUICIO,'2','No','9','No identificado') AUDIENCIA_JUICIO FROM TR_FED_ORDINARIO\n" +
"WHERE (AUDIENCIA_JUICIO in (2,9) AND incompetencia=2 and  (FECHA_AUDIENCIA_JUICIO IS NOT NULL)AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' ))"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
public ArrayList Estatus_ExpedienteNI(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="select  CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(ESTATUS_EXPEDIENTE,'9','No_identificado') ESTATUS_EXPEDIENTE,REPLACE(COMENTARIOS,',','')COMENTARIOS from TR_FED_ORDINARIO\n" +
...
public ArrayList IncompetenciaNI(){
      ...
      Array = new ArrayList();
      sql="select * from(\n" +
"select CLAVE_ORGANO,EXPEDIENTE_CLAVE,INCOMPETENCIA,REPLACE(COMENTARIOS,',','')COMENTARIOS from TR_FED_ORDINARIO\n" +
...
public ArrayList Tipo_IncompetenciaNI(){
      ...
      sql="select * from(\n" +
" SELECT * FROM(\n" +
"SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(INCOMPETENCIA,'2','No') INCOMPETENCIA,TIPO_INCOMPETENCIA FROM TR_FED_ORDINARIO WHERE INCOMPETENCIA=2)\n" +
...
public ArrayList PivIncompetencia(){
      ...
      sql="SELECT * FROM(\n" +
"SELECT * FROM(\n" +
"select CLAVE_ORGANO,EXPEDIENTE_CLAVE,INCOMPETENCIA from TR_FED_ORDINARIO\n" +
...
"TIPO_SENTENCIAAJ IS NOT NULL OR MONTO_SOLUCIONAJ IS NOT NULL) where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
...
"SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,ESTATUS_DEMANDA FROM TR_FED_ORDINARIO WHERE \n" +
"FECHA_ADMI_DEMANDA IS NOT NULL OR  CANTIDAD_ACTORES IS NOT NULL OR\n" +
"CANTIDAD_DEMANDADOS IS NOT NULL OR  AUDIENCIA_PRELIM IS NOT NULL OR \n" +
"FECHA_AUDIENCIA_PRELIM IS NOT NULL OR  AUDIENCIA_JUICIO IS NOT NULL OR \n" +
"FECHA_AUDIENCIA_JUICIO IS NOT NULL OR \n" +
...
"FORMA_SOLUCIONAJ IS NOT NULL OR OTRO_ESP_SOLUCIONAJ IS NOT NULL OR FECHA_RESOLUCIONAJ IS NOT NULL OR \n" +
"TIPO_SENTENCIAAJ IS NOT NULL OR MONTO_SOLUCIONAJ IS NOT NULL)where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"'  )WHERE ESTATUS_DEMANDA IN (2,3,4)"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
...
"FORMA_SOLUCIONAJ IS NOT NULL OR OTRO_ESP_SOLUCIONAJ IS NOT NULL OR FECHA_RESOLUCIONAJ IS NOT NULL OR \n" +
"TIPO_SENTENCIAAJ IS NOT NULL OR MONTO_SOLUCIONAJ IS NOT NULL)where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"'  )WHERE ESTATUS_DEMANDA IN (9)"; 
      System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
...
public ArrayList Estatus_Expediente(){
      ...
      sql="SELECT * FROM(\n" +
"SELECT * FROM(\n" +
"SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,ESTATUS_EXPEDIENTE FROM TR_FED_ORDINARIO WHERE FASE_SOLI_EXPEDIENTE IS NOT NULL OR \n" +
"FORMA_SOLUCIONFE IS NOT NULL OR  OTRO_ESP_SOLUCIONFE IS NOT NULL OR \n" +
"FECHA_DICTO_RESOLUCIONFE IS NOT NULL OR MONTO_SOLUCION_FE IS NOT NULL OR\n" +
"FORMA_SOLUCIONAP IS NOT NULL OR  OTRO_ESP_SOLUCIONAP IS NOT NULL OR\n" +
"FECHA_DICTO_RESOLUCIONAP IS NOT NULL OR  MONTO_SOLUCION_AP IS NOT NULL OR \n" +
...
"FORMA_SOLUCIONAJ IS NOT NULL OR OTRO_ESP_SOLUCIONAJ IS NOT NULL OR FECHA_RESOLUCIONAJ IS NOT NULL OR \n" +
"TIPO_SENTENCIAAJ IS NOT NULL OR MONTO_SOLUCIONAJ IS NOT NULL) where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"'  ) WHERE ESTATUS_EXPEDIENTE=9";      
 System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
...
"from TR_FED_ORDINARIO WHERE ESTATUS_EXPEDIENTE=1 AND\n" +
...
"FROM TR_FED_ORDINARIO P, TC_FED_FASE_EXPEDIENTE S\n" +
"WHERE  P.FASE_SOLI_EXPEDIENTE=S.ID\n" +
"AND FASE_SOLI_EXPEDIENTE NOT IN(1,2,9,99) AND (SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"'  )"; 
System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
//Cuando Fase de solicitud del expediente (FASE_SOLI_EXPEDIENTE) =No identificado, no debe capturar desde Forma de solución (FORMA_SOLUCIONFE) hasta Monto estipulado en la forma de solución (MONTO_SOLUCIONAJ).
public ArrayList Fase_Sol_expNI(){
      conexion.Conectar();
      Array = new ArrayList();
      sql="SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,DECODE(FASE_SOLI_EXPEDIENTE,'99','No identificado')FASE_SOLI_EXPEDIENTE FROM TR_FED_ORDINARIO \n" +
...
public ArrayList Fase_Sol_exp_FE(){
      ...
      sql="SELECT * FROM(\n" +
"SELECT * FROM(\n" +
"SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,FASE_SOLI_EXPEDIENTE FROM TR_FED_ORDINARIO WHERE \n" +
"FORMA_SOLUCIONAP IS NOT NULL OR  OTRO_ESP_SOLUCIONAP IS NOT NULL OR\n" +
"FECHA_DICTO_RESOLUCIONAP IS NOT NULL OR  MONTO_SOLUCION_AP IS NOT NULL OR \n" +
"FORMA_SOLUCIONAJ IS NOT NULL OR OTRO_ESP_SOLUCIONAJ IS NOT NULL OR FECHA_RESOLUCIONAJ IS NOT NULL OR \n" +
"TIPO_SENTENCIAAJ IS NOT NULL OR MONTO_SOLUCIONAJ IS NOT NULL) where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"'  ) WHERE FASE_SOLI_EXPEDIENTE IN (9)\n" +
""; 
System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
...
"FORMA_SOLUCIONAJ IS NOT NULL OR OTRO_ESP_SOLUCIONAJ IS NOT NULL OR FECHA_RESOLUCIONAJ IS NOT NULL OR \n" +
"TIPO_SENTENCIAAJ IS NOT NULL OR MONTO_SOLUCIONAJ IS NOT NULL) where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"'  ) WHERE FASE_SOLI_EXPEDIENTE IN (1)"; 
System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
...
"FECHA_DICTO_RESOLUCIONAP IS NOT NULL OR  MONTO_SOLUCION_AP IS NOT NULL OR\n" +
"FORMA_SOLUCIONFE IS NOT NULL OR  OTRO_ESP_SOLUCIONFE IS NOT NULL OR \n" +
"FECHA_DICTO_RESOLUCIONFE IS NOT NULL OR MONTO_SOLUCION_FE IS NOT NULL ) where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"'  ) WHERE FASE_SOLI_EXPEDIENTE IN (2)"; 
System.out.println(sql);
      resul=conexion.consultar(sql);
      try {
          while (resul.next()) {
...
"    AND circuns_motivo_confl = 1  and(SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"'  \n" +
" or clave_organo='"+PValidacion.clave_organo+"' )"; 
System.out.println(sql);
      resul=conexion.consultar(sql);
      try {

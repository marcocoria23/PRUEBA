 ...
 */
public class V3QPart_dem_huelgaFederal {
...
" and incompetencia=2) where \n" +
" CANTIDAD_DEMANDADOS>0) where expediente_clave not in (select expediente_clave from TR_FED_part_dem_HUELGA where  SUBSTR(CLAVE_ORGANO,0,2)='"+PValidacion.clave_entidad+"' \n" +

 ...
 */
public class V3QIndividualFederal {
    ...
    public ArrayList Año_JudicialCampeche() {
        ...
        sql = "SELECT * FROM (\n"
                ...
                + "        from TR_FED_individual ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO) WHERE SUBSTR(CLAVE_ORGANO,0,2)='" + PValidacion.clave_entidad + "'  \n"
    ...
    public ArrayList Año_Expe_IndividualNE() {
        ...
        sql = "SELECT * FROM(\n"
                ...
                + "from TR_FED_individual ) WHERE  FECHA_APERTURA_EXPEDIENTE <>EXPE_AÑO AND EXPE_AÑO NOT IN ('2021','2022','2023','2020','2024','2025')) WHERE SUBSTR(CLAVE_ORGANO,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "or clave_organo='" + PValidacion.clave_organo + "'";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
    ...
    public ArrayList FECHA_APERTURA_EXPEDIENTE_FUT() {
        ...
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_INDIVIDUAL  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_AUDIENCIA_PRELIM_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_AUDIENCIA_PRELIM,'DD/MM/YYYY')FECHA_AUDIENCIA_PRELIM,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_INDIVIDUAL  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_DICTO_RESOLUCION_AD_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_DICTO_RESOLUCION_AD,'DD/MM/YYYY')FECHA_DICTO_RESOLUCION_AD,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_INDIVIDUAL  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_RESOLUCION_TA_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_RESOLUCION_TA,'DD/MM/YYYY')FECHA_RESOLUCION_TA,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_INDIVIDUAL  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_DICTO_RESOLUCION_AP_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_DICTO_RESOLUCION_AP,'DD/MM/YYYY')FECHA_DICTO_RESOLUCION_AP,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_INDIVIDUAL  \n"
                + "WHERE \n"
    ...
    public ArrayList FECHA_DICTO_RESOLUCION_AJ_FUT() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT clave_organo, expediente_clave, TO_CHAR(FECHA_DICTO_RESOLUCION_AJ,'DD/MM/YYYY')FECHA_DICTO_RESOLUCION_AJ,\n"
                + "TO_CHAR(SYSDATE,'DD/MM/YYYY') FROM  TR_FED_INDIVIDUAL  \n"
                + "WHERE \n"
   ...
   public ArrayList Duplicidad_expediente() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "SELECT CLAVE_ORGANO,EXPEDIENTE_CLAVE,TO_CHAR(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY')FECHA_APERTURA_EXPEDIENTE,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2 FROM TR_FED_INDIVIDUAL\n"
                ...
                + "select CLAVE_ORGANO,expediente_clave,TO_NUMBER(regexp_replace(expediente_clave, '[^0-9]', ''))expediente_clave2 from TR_FED_INDIVIDUAL \n"
  ...
  //Query de validacion donde la fecha de admision no debe de ser menor a la fecha de apertura del expediente
    public ArrayList Fecha_Admi_demandaNE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(fecha_admi_demanda,'DD/MM/YYYY') fecha_admi_demanda ,COMENTARIOS\n"
                + "from TR_FED_individual where \n"
...
//Query de validacion donde la Fecha de audiencia preliminar no debe de ser menor o igual a la fecha de apertura del expediente
    public ArrayList Fecha_Audiencia_PrelimNE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_AUDIENCIA_PRELIM,'DD/MM/YYYY') FECHA_AUDIENCIA_PRELIM  \n"
                + "from TR_FED_individual where \n"
                + " FECHA_AUDIENCIA_PRELIM <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_AUDIENCIA_PRELIM <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_AUDIENCIA_PRELIM,'dd/mm/yyyy')  <= to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
...
//Query de validacion donde la  Fecha en la que se dictó la resolución (auto depuracion) no debe de ser menor a la fecha de apertura del expediente
    public ArrayList Fecha_Dicto_Resolucion_AdNE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_DICTO_RESOLUCION_AD,'DD/MM/YYYY') FECHA_DICTO_RESOLUCION_AD  \n"
                + "from TR_FED_individual where \n"
                + " FECHA_DICTO_RESOLUCION_AD <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_DICTO_RESOLUCION_AD <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_DICTO_RESOLUCION_AD,'dd/mm/yyyy')  < to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
...
//Query de validacion donde la  Fecha en la que se dictó la resolución (Tramitación sin audiencias) no debe de ser menor a la fecha de apertura del expediente
    public ArrayList Fecha_Resolucion_TaNE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_RESOLUCION_TA,'DD/MM/YYYY') FECHA_RESOLUCION_TA  \n"
                + "from TR_FED_individual where\n"
                + "  FECHA_RESOLUCION_TA <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_RESOLUCION_TA <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_RESOLUCION_TA,'dd/mm/yyyy')  < to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
...
//Query de validacion donde la  Fecha en la que se dictó la resolución  (Audiencia preliminar) no debe de ser menor a la fecha de apertura del expediente
    public ArrayList Fecha_Resolucion_ApNE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_DICTO_RESOLUCION_AP,'DD/MM/YYYY') FECHA_DICTO_RESOLUCION_AP \n"
                + "from TR_FED_individual where\n"
                + " FECHA_DICTO_RESOLUCION_AP <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_DICTO_RESOLUCION_AP <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_DICTO_RESOLUCION_AP,'dd/mm/yyyy')  < to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
...
//Query de validacion donde la  Fecha en la que se dictó la resolución  (Audiencia de juicio) no debe de ser menor a la fecha de apertura del expediente
    public ArrayList Fecha_Resolucion_AjNE() {
        conexion.Conectar();
        Array = new ArrayList();
        sql = "select * from (select entidad_clave,clave_organo,expediente_clave,to_char(FECHA_APERTURA_EXPEDIENTE,'DD/MM/YYYY') FECHA_APERTURA_EXPEDIENTE,to_char(FECHA_DICTO_RESOLUCION_AJ,'DD/MM/YYYY') FECHA_DICTO_RESOLUCION_AJ \n"
                + "from TR_FED_individual where \n"
                + " FECHA_DICTO_RESOLUCION_AJ <> '09/09/1899'  and clave_organo='" + PValidacion.clave_organo + "' or substr(clave_organo,0,2)='" + PValidacion.clave_entidad + "' \n"
                + "and FECHA_DICTO_RESOLUCION_AJ <> '09/09/1899'\n"
                + " ) where  to_date(FECHA_DICTO_RESOLUCION_AJ,'dd/mm/yyyy')  < to_date(FECHA_APERTURA_EXPEDIENTE,'dd/mm/yyyy')";
        System.out.println(sql);
        resul = conexion.consultar(sql);
        try {
            while (resul.next()) {
...
// LA FECHA DE AUDIENCIA CELEBRARA NO DEBE SER MENOR A LA FECHA DE PRESENTACION DE LA DEMANDA
    public ArrayList Fecha_Aud_Presentacion() {
        ...
        sql = "select * from (SELECT S.ENTIDAD_CLAVE,P.CLAVE_ORGANO,P.EXPEDIENTE_CLAVE,to_char(P.FECHA_AUDIEN_CELEBRADA,'DD/MM/YYYY')FECHA_AUDIEN_CELEBRADA,to_char(S.FECHA_PRES_DEMANDA,'DD/MM/YYYY') FECHA_PRES_DEMANDA, P.TIPO_PROCED,P.ID_AUDIENCIA\n"
                + "FROM TR_FED_AUDIENCIAS P,TR_FED_INDIVIDUAL S\n"
